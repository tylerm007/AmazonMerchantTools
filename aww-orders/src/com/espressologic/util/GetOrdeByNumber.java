...
public class GetOrdeByNumber {
	...
	public GetOrdeByNumber() {
		initRequest();
	}
	public GetOrdeByNumber(String sellerID, String marketplaceId,
			String mwsAuthToken) {
	...
	public static void main(String[] args) {
		...
		GetOrdeByNumber order = new GetOrdeByNumber();
		System.out.println(order.findOrder("113-7838341-0494651"));
