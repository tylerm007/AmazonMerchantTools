...
public class AWSItemLookup {
     ...
     * 
     */
    private static final String ENDPOINT =  "mws.amazonservices.com";
    ...
    public static void main(String[] args) {
        ...
        //params.put("IdList.UPC", "790011020059");
        //params.put("ResponseGroup", "Medium");
        params.put("AssociateTag", "4787-2538-5425*");

        requestUrl = helper.sign(params);
        System.out.println("Signed Request is \"" + requestUrl + "\"");

        //System.setProperty("http.proxyHost", "http://192.168.56.1");
        ...
        String queryString = "Service=AWSECommerceService&Version=2009-03-31&Operation=ItemLookup&ResponseGroup=Small&ItemId="+"790011020059";
    ...
    private static String fetchTitle(String requestUrl) {
        ...
        try {
            ...
            if(doc.getElementsByTagName("Title") == null) return null;
